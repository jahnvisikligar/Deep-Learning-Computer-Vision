...
#print(output_.shape)
#saving the Low resolution(LR) LR_image
iio.imsave("lr_img.jpg", LR_image)

#saving the High Resolution(HR) HR_image
iio.imsave("hr_img.jpg", HR_image)

#saving Super resolution(SR) image
iio.imsave("SR_img.jpg", output_)

PSNR_LR_HR = skimage.metrics.peak_signal_noise_ratio(HR_image, LR_image)
print("Value of PSNR for Interpolated image :- ",PSNR_LR_HR)

PSNR_OP_HR = skimage.metrics.peak_signal_noise_ratio(output_, HR_image)
print("Value of PSNR for SRCNN :- ",PSNR_OP_HR)
